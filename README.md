...
| `photography/phideo-photo-0{1..6}-*.png` | The reference photoshoot (reshot 2026-09-17 on GPT-Image 2.5, 2K, with the mechanic as canon): six directed shots covering the everyday and campaign registers, each brief written by the five-role crew (CD, photographer, set dresser, lighting specialist, graphic designer) — see the Photography section of the guide for the shot notes and the photo-treatment rules. |
| `photography/plate-{m,s,w}.png` | Layout plates shot **to the wireframe** (point of interest in the upper half, quiet scrimmable copy footprint below) and passed through CD QA — used by the photo-hero demo, the wireframe diagram and the two photo-hero email templates. |
